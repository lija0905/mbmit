        ...
        <div class="body flex-grow-1 px-3">
            <div class="container-lg">
                <div class="row">
                    <div class="col-12">
                        <div class="card mb-4">
                            <div class="card-header"><strong>Izmeni vest</strong></div>
                            <div class="card-body">
                                @if(session("message"))
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered datatable">
                                            ...
                                            <tr>
                                                <th>Title</th>
                                                <td>
                                                    <input class="form-control @error('title') is-invalid @enderror" name="title" id="title" type="text" value="{{ $news->title }}"/>
                                            ...
                                            <tr>
                                                <th>Naslov</th>
                                                <td>
                                                    <input class="form-control @error('naslov') is-invalid @enderror" name="naslov" id="naslov" type="text" value="{{ $news->naslov }}" />
                                            ...
                                            <tr>
                                                <th>Content</th>
                                                <td>
                                                    <textarea rows="4" class="form-control  @error('content') is-invalid @enderror" name="content" id="content" type="text">{{ $news->content }}</textarea>
                                            ...
                                            <tr>
                                                <th>Sadržaj</th>
                                                <td>
                                                    <textarea rows="4" class="form-control  @error('sadrzaj') is-invalid @enderror" name="sadrzaj" id="sadrzaj" type="text">{{ $news->sadrzaj }}</textarea>
                                                ...
                                                <td>
                                                    ...
                                                    @if(isset($news->photo))
                                                        <div class="row pt-3 w-100">
                                                            <div class="col-sm-3">
                                                                <img src="{{ asset('/storage/news/'.$news->photo) }}" class="w-75">
                                                                <i class="cil-trash cover-photo" style="color: red; font-size: 20px;"  id="{{ $news->id }}"></i>
                                                            </div>
                                                        </div>
                                                    @endif
                                                </td>
