        ...
        <div class="body flex-grow-1 px-3">
            <div class="container-lg">
                <div class="row">
                    <div class="col-12">
                        <div class="card mb-4">
                            <div class="card-header"><strong>Dodaj diseminaciju</strong></div>
                            <div class="card-body">
                                @if(session("message"))
                                ...
                                @endif
                                <form method="POST" action="{{ route('disseminations.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered datatable">
                                            ...
                                            <tr>
                                                <th>Content</th>
                                                <td>
                                                    <textarea    class="form-control @error('content') is-invalid @enderror" name="content" id="content" type="text"></textarea>
                                            ...
                                            <tr>
                                                <th>Link</th>
                                                <td>
                                                    <input class="form-control @error('link') is-invalid @enderror" name="link" id="link" type="text"/>
                                    ...
                                    <button type="submit" class="btn btn-light-green">Dodaj diseminaciju</button>
                                </form>
                            </div>
                        </div>
                    </div>
